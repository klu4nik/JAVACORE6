...
public class Solution {
    ...
    CollegeStudent collegeStudent3 = new CollegeStudent("third", "case", 1, cources, 1, "college", 1,1);

    SpecialStudent specialStudent1 = new SpecialStudent("first", cources);
    SpecialStudent specialStudent2 = new SpecialStudent("second", "case", 1);
    SpecialStudent specialStudent3 = new SpecialStudent(3);
